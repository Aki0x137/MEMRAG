"""Layer 3 shared memory recall against Qdrant shared_memories collection."""
...
async def recall_shared_memory(
    ...
    """Recall top-k shared memories for the given workspace and query."""
    ...
    points = cast(list[Any], _hybrid_query(dense_embedding, sparse_payload, query_filter, top_k))
